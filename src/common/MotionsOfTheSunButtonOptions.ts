/**
 * MotionsOfTheSunButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = MotionsOfTheSunColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link MotionsOfTheSunColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: MotionsOfTheSunColors.controlSurfaceColorProperty,
  listFill: MotionsOfTheSunColors.controlSurfaceColorProperty,
  buttonStroke: MotionsOfTheSunColors.panelBorderColorProperty,
  listStroke: MotionsOfTheSunColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: MotionsOfTheSunColors.textColorProperty },
  },
