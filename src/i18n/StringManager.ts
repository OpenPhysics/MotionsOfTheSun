...
export class StringManager {
  ...
  public getScreenNames(): {
    readonly sunPathsStringProperty: ReadOnlyProperty<string>;
    readonly siderealSolarTimeStringProperty: ReadOnlyProperty<string>;
    readonly zodiacStringProperty: ReadOnlyProperty<string>;
  } {
    return {
      sunPathsStringProperty: stringProperties.screens.sunPathsStringProperty,
      siderealSolarTimeStringProperty: stringProperties.screens.siderealSolarTimeStringProperty,
      zodiacStringProperty: stringProperties.screens.zodiacStringProperty,
    };
  }
   ...
   */
  public getSunPathsA11yStrings() {
    return stringProperties.a11y.sunPaths;
  }

  public getSiderealSolarTimeA11yStrings() {
    return stringProperties.a11y.siderealSolarTime;
  }
