 ...
 *
 * ── Adding content ────────────────────────────────────────────────────────────
 * 1. Create Node subclasses in separate files (e.g. ZodiacControlPanel.ts)
...
export class ZodiacScreenView extends ScreenView {
  public constructor(model: ZodiacModel, options?: ScreenViewOptions) {
    ...
    // it the same way. See ZodiacScreenSummaryContent for the four content regions.
    super({
    ...
    const placeholderText = new Text("Zodiac", {
