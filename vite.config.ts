    ...
    plugins: single
      ...
      : [
          VitePWA({
            ...
            manifest: {
              id: "motions-of-the-sun",
              name: "Motions of the Sun",
              // biome-ignore lint/style/useNamingConvention: Web App Manifest spec requires snake_case keys
              short_name: "Sun Motions",
              description: "The Sun's daily and annual motions through the sky — a NAAP lab port",
